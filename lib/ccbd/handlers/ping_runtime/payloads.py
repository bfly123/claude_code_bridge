...
def build_ccbd_payload(
    *,
    ...
    return {
        ...
        'ipc_kind': inspection.lease.ipc_kind if inspection.lease else None,
        'backend_family': inspection.lease.backend_family if inspection.lease else None,
        'backend_impl': inspection.lease.backend_impl if inspection.lease else None,

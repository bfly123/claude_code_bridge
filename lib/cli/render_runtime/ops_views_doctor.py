...
def render_doctor(payload: Mapping[str, object]) -> tuple[str, ...]:
    ...
    lines = [
        ...
        f'ccbd_ipc_kind: {ccbd.get("ipc_kind")}',
        f'ccbd_ipc_ref: {ccbd.get("ipc_ref")}',
        f'ccbd_ipc_state: {ccbd.get("ipc_state")}',
        f'ccbd_ipc_updated_at: {ccbd.get("ipc_updated_at")}',
        f'ccbd_backend_family: {ccbd.get("backend_family")}',
        f'ccbd_backend_impl: {ccbd.get("backend_impl")}',
        ...
        f'ccbd_namespace_backend_ref: {ccbd.get("namespace_backend_ref")}',
        f'ccbd_namespace_session_name: {ccbd.get("namespace_session_name")}',
        f'ccbd_namespace_workspace_name: {ccbd.get("namespace_workspace_name")}',
        ...
        f'ccbd_namespace_last_event_backend_ref: {ccbd.get("namespace_last_event_backend_ref")}',

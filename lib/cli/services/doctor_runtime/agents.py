...
def agent_summary(
    ...
    *,
    ...
    return {
        ...
        'runtime_pid': getattr(runtime, 'runtime_pid', None) if runtime is not None else None,
        'runtime_root': getattr(runtime, 'runtime_root', None) if runtime is not None else None,
        'session_file': getattr(runtime, 'session_file', None) if runtime is not None else None,
